...
const logIn = (email, password) => (dispatch) => {
  ...
  dispatch(
    createAction({
      endpoint: `http://${process.env.REACT_APP_SERVER_HOST}:${process.env.REACT_APP_SERVER_PORT}/users/logIn?email=${email}&pwd=${pwd}`,
      method: "GET",
      headers: {
...
const addUser = (email, username, password, dateOfBirth) => (dispatch) => {
  ...
  dispatch(
    createAction({
      endpoint: `http://${process.env.REACT_APP_SERVER_HOST}:${process.env.REACT_APP_SERVER_PORT}/users/${email}/${pwd}/${dateOfBirth}/${username}`,
      method: "POST",
      headers: {
        Accept: "application/json",
        "Content-Type": "application/json",
...
const updateUser = (data, id) => (dispatch) => {
  ...
  dispatch(
    createAction({
      endpoint: `http://${process.env.REACT_APP_SERVER_HOST}:${process.env.REACT_APP_SERVER_PORT}/users/${id}${q}`,
      method: "PUT",
      headers: {
        Accept: "application/json",
        "Content-Type": "application/json",
...
const userExist = (email) => (dispatch) =>
  dispatch(
    createAction({
      endpoint: `http://${process.env.REACT_APP_SERVER_HOST}:${process.env.REACT_APP_SERVER_PORT}/users/exist?email=${email}`,
      method: "GET",
      headers: {
        Accept: "application/json",
        "Content-Type": "application/json",
...
const getFavorites = (user) => (dispatch) =>
  dispatch(
    createAction({
      endpoint: `http://${process.env.REACT_APP_SERVER_HOST}:${process.env.REACT_APP_SERVER_PORT}/favorites/user?userId=${user}`,
      method: "GET",
      headers: {
        Accept: "application/json",
        "Content-Type": "application/json",
...
const addFavorite = (user, video, title, url) => (dispatch) => {
  dispatch(
    createAction({
      endpoint: `http://${process.env.REACT_APP_SERVER_HOST}:${process.env.REACT_APP_SERVER_PORT}/favorites/${video}/${user}/${encodeURIComponent(title)}/${encodeURIComponent(url)}`,
      method: "POST",
      options: {
        video,
        user,
...
const delFavorite = (user, video) => (dispatch) =>
  dispatch(
    createAction({
      endpoint: `http://${process.env.REACT_APP_SERVER_HOST}:${process.env.REACT_APP_SERVER_PORT}/favorites?userId=${user}&videoId=${video}`,
      method: "DELETE",
      headers: {
        Accept: "application/json",
        "Content-Type": "application/json",
...
const imgGet = (user) => (dispatch) =>
  dispatch(
    createAction({
      endpoint: `http://${process.env.REACT_APP_SERVER_HOST}:${process.env.REACT_APP_SERVER_PORT}/image/avatar/${user}`,
      method: "GET",
      headers: {
        Accept: "application/json",
        "Content-Type": "application/json",
